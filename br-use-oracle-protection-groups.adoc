...
summary: Créez et gérez des groupes de protection pour les charges de travail Oracle Database dans NetApp Backup and Recovery. 
---
...
[role="lead"]
Créez des groupes de protection pour gérer les opérations de sauvegarde des ressources Oracle Database. Un groupe de protection est un regroupement logique de ressources, telles que des bases de données, que vous souhaitez protéger ensemble.
...
* Sauvegardez un groupe de protection maintenant. Voir link:br-use-oracle-backup.html["Sauvegardez dès maintenant les charges de travail Oracle Database"].
...
Regroupez les ressources de base de données Oracle que vous souhaitez protéger ensemble dans un groupe de protection.
...
. Sélectionnez les bases de données que vous souhaitez inclure dans le groupe de protection.
