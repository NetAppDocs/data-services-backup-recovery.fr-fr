...
---
= Découvrez comment protéger les charges de travail Oracle Database avec NetApp Backup and Recovery
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Protégez les bases de données et journaux Oracle à l'aide de NetApp Backup and Recovery. Obtenez des sauvegardes et des restaurations rapides, économes en espace, cohérentes en cas de panne et cohérentes au niveau de la base de données. Sauvegardez les charges de travail Oracle Database vers AWS S3, NetApp StorageGRID, Azure Blob Storage ou ONTAP S3. Restaurez les sauvegardes sur un hôte Oracle sur site.
