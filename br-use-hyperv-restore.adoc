...
* Restaurer à partir d'une sauvegarde de stockage objet (uniquement vers l'emplacement d'origine)



NOTE: La restauration à partir d'une sauvegarde d'objet store n'est pas prise en charge pour les machines virtuelles résidant sur un stockage SAN.
...
* Restaurer vers un autre emplacement (à partir du stockage principal et secondaire)
