...
Depuis la page Restaurer, vous pouvez restaurer une ressource, même si vous ne vous souvenez pas de son nom exact, de son emplacement ou de la date à laquelle elle était en bon état. Vous pouvez rechercher l'instantané à l'aide de filtres.
...
Restaurez les charges de travail Hyper-V à l'aide du menu Restaurer. Vous pouvez rechercher l'instantané par son nom ou à l'aide de filtres.
