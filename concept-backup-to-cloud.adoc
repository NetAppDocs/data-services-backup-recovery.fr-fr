...
* *Charges de travail VMware (avec nouvelle interface utilisateur sans SnapCenter Plug-in for VMware vSphere)* :
+
** Protégez vos machines virtuelles et banques de données VMware avec NetApp Backup and Recovery.
** Sauvegardez les charges de travail VMware sur Amazon Web Services S3 ou StorageGRID.
...
* Microsoft Azure Blob (non disponible pour les charges de travail VMware)
* StorageGRID
* ONTAP S3 (non disponible pour les charges de travail VMware)
