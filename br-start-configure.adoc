...
* <<Ajouter des informations d'identification pour les ressources de l'hôte>> pour tout hôte Windows, Microsoft SQL Server, Oracle Database ou Linux avec lequel NetApp Backup and Recovery doit s'authentifier. Cela inclut les informations d'identification du système d'exploitation invité utilisées lors de la restauration de fichiers ou de dossiers.
...
Créez des modèles de transformation de ressources pour stocker les transformations courantes que vous effectuez sur les ressources lors de leur restauration.

.Étapes
. Dans le menu NetApp Backup and Recovery , sélectionnez *Paramètres*.
. Sélectionnez la flèche vers le bas pour développer la section *Resource modifer template*.
