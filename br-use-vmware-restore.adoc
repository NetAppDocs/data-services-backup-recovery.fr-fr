...
+
*** *Modifier l'emplacement de stockage par défaut* : activez cette option pour restaurer une sauvegarde d'object store sur une autre machine virtuelle de stockage si l'emplacement de stockage source est inaccessible ou saturé. Choisissez un autre cluster, une autre machine virtuelle de stockage ou un autre agrégat à utiliser.
