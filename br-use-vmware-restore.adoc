...
. Trouvez dans la liste la machine virtuelle que vous souhaitez restaurer, puis sélectionnez le bouton *Restaurer la machine virtuelle* correspondant.
+
Une liste des instantanés (points de restauration) créés sur cette machine virtuelle s'affiche.

. Cochez la case correspondant à l'instantané que vous souhaitez restaurer.
...
*** *Banque de données* : Saisissez le nom de la banque de données dans laquelle vous souhaitez restaurer l’instantané.
