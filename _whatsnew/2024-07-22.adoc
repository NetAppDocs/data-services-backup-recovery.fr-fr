...
Pour plus de détails sur la manière de l'activer manuellement, reportez-vous à https://community.netapp.com/t5/Tech-ONTAP-Blogs/BlueXP-Backup-and-Recovery-July-2024-Release/ba-p/453993["Blog sur la version de juillet 2024 de NetApp Backup and Recovery"].
