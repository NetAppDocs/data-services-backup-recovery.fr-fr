...
** Choisissez une durée d'exécution pour le script. Si le script ne parvient pas à s'exécuter dans ce délai, la restauration se poursuit malgré tout.
...
** *Ouvrez la base de données ou la base de données conteneur en mode LECTURE-ÉCRITURE après la récupération* : Une fois l’opération de restauration terminée, Backup and Recovery active le mode LECTURE-ÉCRITURE pour la base de données.
