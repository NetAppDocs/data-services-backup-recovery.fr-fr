...
[role="lead"]
Supprimez les instantanés locaux de Microsoft SQL Server à partir de NetApp Backup and Recovery.
...
. Sélectionnez la base de données dont vous souhaitez supprimer l’instantané.
. Dans le menu Actions, sélectionnez *Afficher les détails de la protection*.
. Sélectionnez l'instantané local à supprimer.
+
