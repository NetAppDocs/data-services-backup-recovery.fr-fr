...
Si vous configurez la stratégie de protection d'une base de données afin de conserver les journaux d'archive, vous pouvez monter les points de récupération de la base de données pour afficher l'historique de toutes les modifications apportées à la base de données.
