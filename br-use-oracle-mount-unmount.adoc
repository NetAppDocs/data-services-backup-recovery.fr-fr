...
[role="lead"]
Montez un point de récupération de base de données Oracle lorsque vous avez besoin d'accéder à la base de données dans un état contrôlé pour les opérations de récupération. Si le catalogage automatique est désactivé, vous pouvez cataloguer manuellement les métadonnées du point de récupération dans le catalogue de récupération RMAN.
...
== Démontez un point de récupération de base de données Oracle
...
== Répertorier un point de récupération de base de données Oracle
