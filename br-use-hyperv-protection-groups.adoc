...
. Modifiez les paramètres du groupe de protection, tels que son nom ou les machines virtuelles qui le composent.
. Sélectionnez *Suivant*.
. Modifiez la politique de protection si nécessaire. Une fois terminé, sélectionnez *Suivant*.
