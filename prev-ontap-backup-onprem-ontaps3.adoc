...
[role="lead"]
Dans NetApp Backup and Recovery, vous pouvez sauvegarder les données de volumes de vos systèmes ONTAP principaux sur site vers ONTAP S3 et, en option, vers un système ONTAP secondaire pour la réplication. Utilisez cette page pour préparer votre environnement et activer les sauvegardes.
...
. *Instantané local* : Choisissez une règle de sauvegarde existante ou créez-en une nouvelle.
+
