...
** Pour que la fonctionnalité de recherche et de restauration de sauvegarde et de récupération NetApp fonctionne, le port 1433 doit être ouvert pour la communication entre l’agent de la console et les services Azure Synapse SQL.
