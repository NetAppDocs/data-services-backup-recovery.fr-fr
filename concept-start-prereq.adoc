...
| Logiciels requis  a| 
* ASP.NET Core Runtime 8.0.23 Hosting Bundle (et tous les correctifs 8.0.x ultérieurs)
* PowerShell 7.4.13
...
* ONTAP 9.13.1 ou version ultérieure
* Amazon FSx for NetApp ONTAP storage systems exécutant la version 9.13.1 ou ultérieure
* Stockage SAN (aperçu) (pris en charge pour les sauvegardes et la restauration à l'emplacement d'origine à partir du stockage principal et secondaire)
