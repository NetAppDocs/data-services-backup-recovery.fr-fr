...
* Si vous utilisez Backup and Recovery avec NetApp Console, vous pouvez souscrire à la licence à la carte (PAYGO) ou acheter une licence BYOL (Bring Your Own License).
...
=== Utilisez un contrat annuel avec des licences marketplace ou BYOL
...
== Configurer les licences pour le déploiement local de NetApp Backup and Recovery

Configurez la licence pour la version sur site de NetApp Console.
...
Vous utilisez le déploiement local de la NetApp Console pour gérer les licences BYOL. Vous pouvez ajouter de nouvelles licences, mettre à jour les licences existantes et consulter l'état des licences depuis la Console.
