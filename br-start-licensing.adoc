...
[role="lead"]
Selon que vous utilisiez NetApp Console ou NetApp Console (déploiement local), vous pouvez obtenir une licence NetApp Backup and Recovery en achetant un abonnement annuel ou à la carte (PAYGO) aux *NetApp Intelligent Services* auprès de votre fournisseur de cloud, ou en achetant une licence personnelle (BYOL) auprès de NetApp. Une licence valide est requise pour activer NetApp Backup and Recovery sur un système, créer des sauvegardes de vos données de production et restaurer des données de sauvegarde sur un système de production.
...
* Achetez une licence directe, également appelée bring-your-own-license (BYOL), auprès de NetApp. Cette option s'applique à la fois à NetApp Console et au déploiement local de Console.
...
Vous utilisez la NetApp Console ou le déploiement local de la Console pour gérer les licences BYOL. Vous pouvez ajouter de nouvelles licences, mettre à jour les licences existantes et consulter l'état des licences depuis la Console.
