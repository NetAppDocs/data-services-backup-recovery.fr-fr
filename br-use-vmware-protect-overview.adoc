...
---
= Flux de travail de protection VMware avec NetApp Backup and Recovery
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Protégez vos machines virtuelles VMware et vos datastores avec NetApp Backup and Recovery. NetApp Backup and Recovery offre des opérations de sauvegarde et de restauration rapides, économes en espace, cohérentes en cas de panne et cohérentes au niveau des machines virtuelles. Vous pouvez sauvegarder les charges de travail VMware vers des cibles de sauvegarde prises en charge et restaurer les charges de travail VMware vers un hôte VMware sur site.
