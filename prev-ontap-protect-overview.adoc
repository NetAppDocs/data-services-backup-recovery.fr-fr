...
| Cloud Volumes ONTAP dans un stockage d'objets compatible S3  a| 
* Cloud Volumes ONTAP dans un stockage d'objets compatible S3
* Système ONTAP sur site
...
| Stockage d'objets compatible S3  a| 
* Cloud Volumes ONTAP dans un stockage d'objets compatible S3
* Système ONTAP sur site
