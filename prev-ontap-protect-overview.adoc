...
---
= Découvrez NetApp Backup and Recovery pour les volumes ONTAP
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
* Si vous prévoyez d'analyser un fichier de sauvegarde à la recherche de ransomwares lors du processus de restauration des données du volume (si vous avez activé Datalock et la protection contre les ransomwares pour vos sauvegardes cloud), alors vous encourrez également des frais de sortie supplémentaires de la part de votre fournisseur de cloud.
