...
.. *Paramètres Hyper-V* : Effectuez les opérations suivantes :
+
...
... Ajoutez un nouvel hôte Hyper-V en saisissant le FQDN ou l'adresse IP de l'hôte, puis en sélectionnant un agent Console et des identifiants. Si le FQDN n'est pas résoluble par l'agent Console, utilisez l'adresse IP à la place. Pour les clusters de basculement, saisissez l'adresse IP de gestion du cluster.


.. *Paramètres avancés* : Vous pouvez éventuellement saisir un chemin d’installation pour le plug-in Hyper-V NetApp.
