...
[role="lead"]
NetApp Backup and Recovery doit d’abord détecter les machines virtuelles Hyper-V afin que vous puissiez les protéger.
...
.Résultat
Une fois que NetApp Backup and Recovery a découvert les ressources, la charge de travail Hyper-V s’affiche dans la liste des charges de travail sur la page Inventaire.
