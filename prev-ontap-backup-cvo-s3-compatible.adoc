...
* Testé et validé avec le stockage d'objets Wasabi ; des clients ont également signalé des déploiements réussis avec MinIO, IBM Cloud Object Storage et Apple Object Store
